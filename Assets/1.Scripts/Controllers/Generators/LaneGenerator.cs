...
public class LaneGenerator : MonoBehaviour {
	...
	public GameObject Generate(Transform parent, LaneData laneData) {
		...
		for (int i = 0; i < repetitions; i++) {
			...
			Vector3 offset = new Vector3(0, 0, i * laneSize);
		...
		if (laneData is RoadLaneData roadLaneData && roadLaneData.hasFrontDirection) {
